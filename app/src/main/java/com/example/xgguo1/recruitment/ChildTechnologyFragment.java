 ...
 */
public class ChildTechnologyFragment extends Fragment {
    ...
    public ChildTechnologyFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_child_technology, container, false);
    ...
    private void getData() {
        ...
        query.findObjects(new FindListener<Recruitment>() {
            ...
            public void done(List<Recruitment> list, BmobException e) {
                ...
                recycleView.setAdapter(new MyRecycleViewAdapter(getActivity(),list));
                myData.addAll(list);
            }
        });
    }
